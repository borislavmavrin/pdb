...
class Net(nn.Module):
	def __init__(self, n_feature, n_hidden1, n_hidden2, n_hidden3, n_hidden4, n_hidden5, n_hidden6, n_hidden7, n_hidden8, n_hidden9, n_hidden10, n_hidden11, n_output):
...
def main():
	data_temp = "compDelta1-7"
	model_temp = "deltaRegresssModel1-7"
	data_name = data_temp+".txt"
	...
	data = Data(data_name, [1, 2, 3, 4, 5, 6, 7], 11520)
